...
jobs:
    validation:
        uses: Home-Office-Digital/core-cloud-workflow-node-npm-actions/.github/workflows/validation.yml@1.3.0
        with:
            working_directory: "."
            node_version: "24"
            audit_level: "low"
    ...
    build-publish:
        uses: Home-Office-Digital/core-cloud-workflow-node-npm-actions/.github/workflows/build-publish.yml@1.3.0
        with:
            working_directory: "."
            node_version: "24"
